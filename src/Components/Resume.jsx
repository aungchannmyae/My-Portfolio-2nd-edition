            ...
            <div>
              ...
              <div className=" pl-3 flex flex-col gap-10">
                  ...
                  <section>
                    <div>
                      <ul className=" text-[#df4f3e]  list-inside list-disc">
                        ...
                        <li className=" ">
                          <h1 className=" ml-[18px] inline-block text-white font-semibold tracking-wider">
                            Started Learning Web Development In MMS-IT Since
                            2022
                          </h1>
                        </li>
                      </ul>
                ...
                <div id=" skills">
                  ...
                  <section>
                    <div className=" shadow-2xl shadow-zinc-950 rounded-lg py-2">
                      <div>
                        <h1 className=" ml-[41px] mb-2 inline-block text-white font-semibold tracking-wider">
                          Responsive Web Design
                        </h1>
                        <span className=" ml-3 text-white tex font-mono">
                          ( 100% )
                        </span>
                ...
                <div id=" experience">
                  ...
                  <section>
                    <p className=" mx-[41px] text-stone-400 font-mono">
                      Software Developer who is seeking the work Experiences in
                      the position as an internship or junior Front End
                      Developer.
                    </p>
                  </section>
                </div>
