        ...
        <Container>
          <div className=" mb-6 ">
            <motion.h1
              ...
              className="  max-lg:text-3xl max-lg:mb-3 max-lg:pb-3 select-none inline-block pb-5 mb-5 border-b-4 border-[#df4f3e] xl:text-3xl lg:text-3xl text-white font-bold "
            >
              About Me
            </motion.h1>
          ...
          <div className=" ">
            <motion.h1
              ...
              whileInView={{ opacity: 1, translateX: 0 }}
              transition={{ duration: 0.8 }}
              className="  inline-block pb-5 mb-5 border-b-4 border-[#df4f3e] max-lg:pb-3 max-lg:mb-3 max-lg:text-3xl xl:text-3xl lg:text-3xl text-white font-bold "
            >
              Resume
            </motion.h1>
                    ...
                    <ul className=" text-[#df4f3e] list-inside list-disc">
                      <li className=" mb-2">
                        <motion.h1
                          ...
                          whileInView={{ opacity: 1, translateX: 0 }}
                          transition={{ duration: 0.8 }}
                          className=" ml-[18px] inline-block max-lg:text-lg xl:text-xl lg:text-xl text-white font-semibold tracking-wider"
                        >
                          B.E.H.S (2) Insein
                        </motion.h1>
                        <motion.p
                  ...
                  <div className=" shadow-2xl shadow-zinc-950 max-lg:text-lg xl:text-xl lg:text-xl rounded-lg py-2">
                    <div>
                      <motion.h1
                        ...
                        whileInView={{ opacity: 1, translateX: 0 }}
                        transition={{ duration: 0.8 }}
                        className=" ml-[41px] mb-2 lg:block xl:inline-block text-white font-semibold tracking-wider"
                      >
                      ...
                      <motion.span
                        ...
                        whileInView={{ opacity: 1, translateX: 0 }}
                        transition={{ duration: 0.8 }}
                        className="lg:block xl:inline-block ml-[41px] lg:mb-3 text-white tex font-mono"
                      >
                        ( 100% )
                      </motion.span>
                        <ProgressLine
                      ...
                      {/* <motion.span
                        ...
                        whileInView={{ opacity: 1, translateX: 0 }}
                        transition={{ duration: 0.8 }}
                        className=" block mx-auto mb-5 w-[93%] h-[5px] rounded-lg bg-neutral-700"
                      >
              ...
              <div className=" pl-3" id=" experience">
                ...
                <section>
                  ...
                  >
                    ...
                    the position as an internship or junior Front End Developer.
                  </motion.p>
                </section>
              </div>
              <div id=" certificates">
                ...
                <section>
                  <div className=" duration-300 grid max-sm:grid-cols-1 max-lg:gap-6 xl:grid-cols-3 md:grid-cols-2 xl:gap-5 lg:gap-10">
                    <motion.div
                      ...
                      transition={{ duration: 0.8 }}
                      className=" overflow-hidden shadow-2xl rounded-lg shadow-zinc-950"
                    >
                      <div className=" h-[220px] overflow-hidden ">
                        <a href="">
                          <img
                            className=" select-none duration-300 rounded-t-lg w-full"
                            src="/photo1.png"
                            alt=""
                          />
                        </a>
