    ...
    <section className={` ${ !aboutMe && 'hidden animate__animated animate__fadeOut' } mb-10 animate__animated animate__fadeIn`}>
      <Container>
        <div>
          ...
          <p className="duration-200 max-lg:mb-6 max-lg:text-xl xl:text-lg lg:text-xl text-stone-400 font-mono mb-10">
          ...
          <section className=" duration-200 grid max-sm:grid-cols-1 max-sm:gap-4 grid-cols-2 xl:gap-5 lg:gap-8">
